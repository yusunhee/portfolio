          ...
          <div className="profile-contents">
            ...
            <div className="on-mouse">
              <div className="stats">
                ...
                <div>
                  <a
                    href="https://www.instagram.com/yusunhee_/"
                    target="_blank"
                  >
            ...
            <div className="mprofile-text">
              <p>NAME. 유선희 |</p>
              <p>BIRTH DATE. 1992년 01월 18일 |</p>
              <p>PHONE. 010 6354 8110 |</p>
              <p>E-MAIL. yusunhee_@naver.com |</p>
            </div>
          </div>
        </div>
          ...
          <div className="contents-text">
            ...
            <div className="text-b">
              <span>
                ...
                서핑을 하면서 정보를 얻습니다.
                <br />
                <br />각 브랜드들의 판촉활동과 홍보전략 디자인을 보기 위해 여러
                장소 방문과 사람들을 만나고 여행을 하며 트렌드를 공부하고 느끼며
                문화와 사회의 흐름을 읽어냅니다.{" "}
                <b>
                  <br />
